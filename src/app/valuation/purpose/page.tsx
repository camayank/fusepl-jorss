      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          <button
            ...
            className="group relative inline-flex items-center justify-center h-12 px-8 text-sm font-semibold tracking-wide bg-[oklch(0.62 0.22 330)] text-white rounded-lg transition-all duration-300 hover:bg-[oklch(0.55 0.20 330)] hover:shadow-[0_0_40px_oklch(0.62_0.22_330/0.25)] active:scale-[0.97]"
          >
