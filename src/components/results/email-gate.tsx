...
const UNLOCKS = [
  ...
  { icon: FileDown, text: 'PDF report download', color: 'oklch(0.78 0.14 75)' },
    ...
    >
      ...
      <div className="relative mb-4 rounded-xl overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex items-center gap-2 bg-[oklch(0.12_0.025_260/0.9)] backdrop-blur-sm px-4 py-2 rounded-full border border-[oklch(0.78_0.14_75/0.2)]">
            <Lock className="h-3.5 w-3.5 text-[oklch(0.78_0.14_75)]" />
      ...
      <div className="relative rounded-2xl overflow-hidden">
        {/* Animated border */}
        <div className="absolute -inset-px rounded-2xl bg-gradient-to-b from-[oklch(0.78_0.14_75/0.3)] via-[oklch(0.78_0.14_75/0.08)] to-[oklch(0.78_0.14_75/0.15)]" />

        <div className="relative rounded-2xl bg-[oklch(0.16_0.015_250)] m-px p-6 sm:p-8">
          {/* Ambient glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[250px] h-[150px] bg-[oklch(0.78_0.14_75/0.04)] blur-[60px] pointer-events-none" />

          <div className="relative">
            <div className="text-center mb-6">
              <h3 className="font-heading text-xl text-[oklch(0.95_0.01_80)] mb-2">
                Unlock Your Full Report
              </h3>
              <p className="text-sm text-[oklch(0.58_0.01_250)]">
                Enter your email to access everything — <span className="text-[oklch(0.78_0.14_75)] font-medium">free during beta</span>.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  required
                  className="w-full h-12 px-4 text-sm rounded-xl bg-[oklch(0.12_0.025_260)] border border-[oklch(0.26_0.018_250)] text-[oklch(0.88_0.005_250)] placeholder:text-[oklch(0.45_0.01_250)] focus:outline-none focus:border-[oklch(0.78_0.14_75/0.4)] focus:shadow-[0_0_0_3px_oklch(0.78_0.14_75/0.06)] transition-all"
                />
              </div>
              <button
                type="submit"
                disabled={!isValidEmail || loading}
                className="group h-12 px-6 text-sm font-semibold rounded-xl bg-[oklch(0.78_0.14_75)] text-[oklch(0.12_0.025_260)] transition-all hover:bg-[oklch(0.72_0.12_75)] hover:shadow-[0_0_24px_oklch(0.78_0.14_75/0.2)] disabled:opacity-40 disabled:cursor-not-allowed whitespace-nowrap flex items-center gap-2"
              >
                {loading ? (
                  <>
