...
export const COMPARABLE_COMPANIES: ComparableCompany[] = [
  ...
  { name: 'PhysicsWallah', sector: 'edtech_test_prep', stage_at_round: 'series_a', last_round_size_cr: 750, valuation_cr: 8100, revenue_cr: 700, year: 2023, city: 'Noida', business_model: 'freemium', source: 'public_announcement' },
  { name: 'Lenskart', sector: 'ecommerce_beauty', stage_at_round: 'series_c_plus', last_round_size_cr: 450, valuation_cr: 37500, revenue_cr: 3200, year: 2024, city: 'Delhi', business_model: 'ecommerce_product', source: 'Tracxn' },
  { name: 'Darwinbox', sector: 'saas_horizontal', stage_at_round: 'series_b', last_round_size_cr: 225, valuation_cr: 5000, revenue_cr: 350, year: 2024, city: 'Hyderabad', business_model: 'saas_subscription', source: 'Tracxn' },
  ...
  { name: 'DeHaat', sector: 'agritech_marketplace', stage_at_round: 'series_b', last_round_size_cr: 150, valuation_cr: 2200, revenue_cr: 400, year: 2023, city: 'Patna', business_model: 'marketplace_commission', source: 'Tracxn' },
  { name: 'Delhivery', sector: 'logistics_last_mile', stage_at_round: 'series_c_plus', last_round_size_cr: 800, valuation_cr: 22000, revenue_cr: 5500, year: 2023, city: 'Gurgaon', business_model: 'services', source: 'public_announcement' },
  ...
  { name: 'Freshworks', sector: 'saas_horizontal', stage_at_round: 'series_c_plus', last_round_size_cr: 1000, valuation_cr: 85000, revenue_cr: 5000, year: 2024, city: 'Chennai', business_model: 'saas_subscription', source: 'public_announcement' },
  { name: 'BrowserStack', sector: 'saas_horizontal', stage_at_round: 'series_b', last_round_size_cr: 1500, valuation_cr: 32000, revenue_cr: 2500, year: 2023, city: 'Mumbai', business_model: 'saas_subscription', source: 'Tracxn' },
  ...
  { name: 'Unacademy', sector: 'edtech_test_prep', stage_at_round: 'series_b', last_round_size_cr: 440, valuation_cr: 24000, revenue_cr: 850, year: 2023, city: 'Bangalore', business_model: 'freemium', source: 'Tracxn' },
  { name: 'Nykaa', sector: 'ecommerce_beauty', stage_at_round: 'series_c_plus', last_round_size_cr: 200, valuation_cr: 55000, revenue_cr: 5300, year: 2024, city: 'Mumbai', business_model: 'ecommerce_product', source: 'public_announcement' },
  ...
  { name: 'Groww', sector: 'fintech_neobroking', stage_at_round: 'series_b', last_round_size_cr: 500, valuation_cr: 25000, revenue_cr: 1200, year: 2024, city: 'Bangalore', business_model: 'transaction_based', source: 'media_report' },
  ...
  { name: 'Tracxn', sector: 'saas_horizontal', stage_at_round: 'series_c_plus', last_round_size_cr: 100, valuation_cr: 2000, revenue_cr: 250, year: 2023, city: 'Bangalore', business_model: 'saas_subscription', source: 'public_announcement' },
  { name: 'Ather Energy', sector: 'auto_ev', stage_at_round: 'series_b', last_round_size_cr: 400, valuation_cr: 8500, revenue_cr: 1800, year: 2024, city: 'Bangalore', business_model: 'hardware_software', source: 'public_announcement' },
  { name: 'Rivigo', sector: 'logistics_last_mile', stage_at_round: 'series_b', last_round_size_cr: 100, valuation_cr: 7500, revenue_cr: 1000, year: 2023, city: 'Gurgaon', business_model: 'services', source: 'Tracxn' },
  { name: 'OYO Rooms', sector: 'travel_booking', stage_at_round: 'series_c_plus', last_round_size_cr: 1500, valuation_cr: 70000, revenue_cr: 5000, year: 2024, city: 'Gurgaon', business_model: 'marketplace_commission', source: 'public_announcement' },
  { name: 'Leadsquared', sector: 'saas_horizontal', stage_at_round: 'series_a', last_round_size_cr: 120, valuation_cr: 2500, revenue_cr: 300, year: 2023, city: 'Bangalore', business_model: 'saas_subscription', source: 'Tracxn' },
]
