...
function generateValuationEmailHTML(data: ValuationEmailData): string {
  ...
  const confidenceColor =
    ...
    data.confidenceScore >= 40 ? '#d4a847' : '#ef4444'
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="padding-bottom:32px;text-align:center;">
              ...
              <span style="font-size:18px;font-weight:700;color:#d4a847;margin-left:8px;">First Unicorn Startup</span>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#161618;border:1px solid #2a2a2e;border-radius:16px;padding:40px 32px;">
              ...
              <!-- Valuation Box -->
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1a1e;border:1px solid #d4a84730;border-radius:12px;padding:24px;margin-bottom:24px;">
                <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="text-align:center;">
                    <a href="${data.reportUrl}" style="display:inline-block;background:#d4a847;color:#0d0d0f;font-size:14px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:10px;">
                      View Full Report
                    </a>
                  </td>
                </tr>
